...
export function ClaimRewardDialog({
  ...
  const hasAmount = reward && "amount" in reward && typeof reward.amount === "number";
          ...
          {!verificationResult ? (
            <>
              ...
              <Button
                ...
                disabled={
                  verifyMutation.isPending || !uniqueCode.trim() || !nationalId.trim()
                }
              >
              ...
              <div className="rounded-lg border border-green-500/30 bg-green-500/5 p-4">
                ...
                {hasAmount && (
                  <p className="text-2xl font-bold text-primary">
                    {formatCurrency((reward as RewardDetail & { amount: number }).amount)}
                  </p>
                )}
