  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          {effectiveCaseId
            ? "Add Biological Evidence to Case"
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="seen_at">
              Date & Time of Collection <span className="text-red-500">*</span>
            </Label>
            <Input
              id="seen_at"
              type="datetime-local"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="coronary">
                Coronary <span className="text-red-500">*</span>
              </Label>
              <Input
                id="coronary"
                type="number"
