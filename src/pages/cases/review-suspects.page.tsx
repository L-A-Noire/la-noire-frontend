...
//     { value: "suspected", label: "Suspect", color: "bg-gray-100 text-gray-800" },
...
//             suspectId: number;
//             status: string;
//         }) => updateSuspectCrimeStatus(suspectId, status),
//         onSuccess: () => {
...
export const ReviewSuspectsPage = () => {
    ...
    const getStatusBadge = (status: string) => {
        const option = STATUS_OPTIONS[status] || { label: status, color: "bg-gray-100 text-gray-800" };
        return (
                                    ...
                                    <div className="flex items-center gap-4 pt-2 border-t">
                                        {suspect.status === "suspected" ? (
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Status: {STATUS_OPTIONS[suspect.status]?.label || suspect.status}
                                            </p>
                                        )}
                                    </div>
                                </div>
