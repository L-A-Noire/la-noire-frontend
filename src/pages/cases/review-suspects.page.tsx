...
import { getSuspectsByCase, updateSuspectStatus, markAsWanted } from "@/api/suspect";
...
const STATUS_OPTIONS = [
    ...
    { value: "most_wanted", label: "Most Wanted", color: "bg-red-100 text-red-800" },
    { value: "arrested", label: "Arrested", color: "bg-blue-100 text-blue-800" },
    { value: "convicted", label: "Convicted", color: "bg-purple-100 text-purple-800" },
    { value: "innocent", label: "Innocent", color: "bg-green-100 text-green-800" },
];
...
export const ReviewSuspectsPage = () => {
    ...
    const updateStatusMutation = useMutation({
        mutationFn: ({ suspectId, status }: { suspectId: number; status: string }) =>
