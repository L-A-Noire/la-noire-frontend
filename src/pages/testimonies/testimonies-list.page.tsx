    ...
    const filteredTestimonies = useMemo(() => {
        ...
        return testimonies.filter((testimony) => {
            const matchesSearch =
                ...
                testimony.description.toLowerCase().includes(searchTerm.toLowerCase()) ||
                testimony.transcription.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    return (
        <div className="container mx-auto py-8 space-y-8">
            ...
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Witness Testimonies</h1>
