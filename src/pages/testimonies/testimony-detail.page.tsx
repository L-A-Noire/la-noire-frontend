    ...
    <div className="container mx-auto py-8 max-w-4xl space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Attachments */}
          {testimony.attachment_details &&
            testimony.attachment_details.length > 0 && (
              <div>
      ...
      {canReview && !testimony.is_confirmed && (
        <Card className="border-blue-200 dark:border-blue-900 bg-blue-50 dark:bg-blue-950/20">
          <CardHeader>
            ...
            <CardDescription>
              Confirm this testimony to create a crime scene. A higher-ranked
              officer will then need to approve the crime scene to create a
              case.
            </CardDescription>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-amber-50 dark:bg-amber-950/20 p-3 rounded border border-amber-200 dark:border-amber-900">
                <p className="text-xs text-amber-800 dark:text-amber-200">
                  <span className="font-bold">Note:</span> Confirming this
                  testimony will create a crime scene. A{" "}
                  {session?.user.role_title === "Chief"
                    ? "case will be created immediately"
                    : "higher-ranked officer must then confirm the crime scene to create a case"}
                  .
                </p>
              </div>
            </CardContent>
